    ...
    return (
        <section className="relative w-full min-h-screen mx-auto overflow-hidden">
            ...
            <div className={`${styles.paddingX} relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between min-h-screen pt-20 lg:pt-0 gap-10 lg:gap-20`}>
                ...
                >
                    ...
                    <motion.p
                        ...
                        className="text-gray-600 dark:text-secondary uppercase tracking-wider text-sm md:text-base font-semibold mb-4"
                    >
                        Hello, I'm
                    </motion.p>
                    ...
                    >
                        <a
                            href="#projects"
                            className="group relative px-8 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-bold rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-violet-500/50"
                        >
                        ...
                        <div className="p-[2px] rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-violet-500/25">
                            <a
                                href="#contact"
                                className="block px-8 py-3 bg-white dark:bg-primary text-gray-900 dark:text-white font-bold rounded-[6px] transition-colors hover:bg-transparent hover:text-white"
                            >
                                Get In Touch
                            </a>
                        </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute -inset-4 rounded-full bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 opacity-75 blur-2xl animate-glow-pulse"></div>

                        {/* Image Container */}
                        <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 p-1">
            ...
            <div className="absolute bottom-10 w-full flex justify-center items-center z-10">
                <a href="#about">
                    <div className="w-[35px] h-[64px] rounded-3xl border-4 border-gray-400 dark:border-secondary flex justify-center items-start p-2 hover:border-violet-500 transition-colors">
                        <motion.div
                            animate={{
                                y: [0, 24, 0]
                            }}
